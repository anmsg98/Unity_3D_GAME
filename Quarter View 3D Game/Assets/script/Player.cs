...
public class Player : MonoBehaviour
{
    ...
    void Move()
    {
        ...
        if (equipWeapon != null && !isFireReady)
            moveVec = Vector3.zero;
    ...
    void Attack()
    {
        ...
        {
            equipWeapon.Use();
            anim.SetTrigger(equipWeapon.type == Weapon.Type.Melee ? "DO_SWING" : "DO_SHOT");
            fireDelay = 0;
        }
    }
    ...
    void Reload()
    {
        ...
        if (rDown && !isJump && !isDodge && !isSwap && isFireReady && (equipWeapon.maxAmmo > equipWeapon.curAmmo))
        {
            anim.SetTrigger("DO_RELOAD");
            isReload = true;
